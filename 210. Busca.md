...
````text
    ...
    TABELA_HASH[SIZE=8]          FUNÇÃO e RETORNO
   +---------+---------+
   | 1       | NULL    |
   | 2       | QUEIROZ |         hash(Queiroz)=2
   | 3       | NULL    |
   | 4       | MOLINA  |         hash(Molina)=4
   | 5       | RAULZIN |         hash(Raulzin)=5
   | 6       | NULL    |
   | 7       | NULL    |
   | 8       | LUGOVI  |         hash(Quiroz)=8
   +-------------------+
