...
Isso significa que podemos declarar variáveis do tipo Cor em nosso código (considerando o exemplo acima), assim como faríamos com int, char, float, etc. Sem o typedef, precisaríamos usar "enum nome_enum" sempre que quiséssemos usar o enum em nosso código.
...
[fonte: Livro de C](https://www.ime.usp.br/~slago/slago-C.pdf)
