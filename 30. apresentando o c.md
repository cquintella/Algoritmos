...
![bg right](../imagens/livro.jpg)

---

## História do C #

* O C nasceu na década de 70 (1972) para portabilidade do sistema UNIX por Dennis Ritchie (1941-2011),
...
![PDP 11 bg left](../imagens/Pdp-11-40.jpg)
...
* É bem provável que o Navegador que você está usando para ler este texto tenha sido escrito em C ou C++*.
 ...
 ![Top Programming Languages](../Top-Prog-lang.png)
